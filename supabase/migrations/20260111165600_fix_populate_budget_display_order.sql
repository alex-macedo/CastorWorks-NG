-- Migration: 20260111165600_fix_populate_budget_display_order.sql
-- Purpose: Fix populate_budget_from_template function - use sort_order instead of display_order
-- Issue: The function was trying to insert into display_order column which doesn't exist in project_phases
