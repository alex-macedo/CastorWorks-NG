-- Migration: Fix populate_budget_from_cost_control_template to use project_budget_lines instead of budget_line_items
-- Purpose: Correct the architectural error where cost control budgets were trying to use the wrong table
...
BEGIN
  ...
  INSERT INTO public.project_budget_versions (
    ...
    'baseline',
    auth.uid(),
    'Auto-generated baseline from WBS template'
