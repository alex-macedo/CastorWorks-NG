-- Migration: Fix Cost Control budget population when schedule phases already exist
-- Purpose: Avoid duplicate key errors by reusing existing project_phases rows regardless of type
