...
- [x] **Phase 2: Module-Based Licensing** — Flexible feature gating at every layer
...
Plans:
- [x] 02-01-PLAN.md — Licensing schema, RPC get_tenant_licensed_modules, seed modules/tiers
- [x] 02-02-PLAN.md — useLicensedModules, ModuleGuard, UpgradePrompt, sidebar required_module filter
- [x] 02-03-PLAN.md — verifyModuleAccess (Edge Functions), super admin tenant module overrides UI
