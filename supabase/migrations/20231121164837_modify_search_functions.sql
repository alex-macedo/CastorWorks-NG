...
create index if not exists fts_search_index on page_section using gin(fts_tokens);

DROP FUNCTION IF EXISTS docs_search_fts(text);
...
DROP FUNCTION IF EXISTS docs_search_embeddings;
