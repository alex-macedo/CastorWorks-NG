...
- **Self-hosted Supabase** behind `https://dev.castorworks.cloud`
- Runs on the provider in a **Docker container** (not in the local dev environment)
- Accessible within the **Docker container** via `supabase-db` hostname
