...
| Bmd Custom Core Bmad Master.agent | bmd-custom-core-bmad-master.agent | — |
| Bmd Custom Bmm Ux Designer.agent | bmd-custom-bmm-ux-designer.agent | — |
| Bmd Custom Bmm Tech Writer.agent | bmd-custom-bmm-tech-writer.agent | — |
| Bmd Custom Bmm Tea.agent | bmd-custom-bmm-tea.agent | — |
| Bmd Custom Bmm Sm.agent | bmd-custom-bmm-sm.agent | — |
| Bmd Custom Bmm Quick Flow Solo Dev.agent | bmd-custom-bmm-quick-flow-solo-dev.agent | — |
| Bmd Custom Bmm Pm.agent | bmd-custom-bmm-pm.agent | — |
| Bmd Custom Bmm Dev.agent | bmd-custom-bmm-dev.agent | — |
| Bmd Custom Bmm Architect.agent | bmd-custom-bmm-architect.agent | — |
| Bmd Custom Bmm Analyst.agent | bmd-custom-bmm-analyst.agent | — |
| Bmd Custom Bmb Workflow Builder.agent | bmd-custom-bmb-workflow-builder.agent | — |
| Bmd Custom Bmb Module Builder.agent | bmd-custom-bmb-module-builder.agent | — |
| Bmd Custom Bmb Agent Builder.agent | bmd-custom-bmb-agent-builder.agent | — |
| Web Accessibility Checker | web-accessibility-checker | — |
| Supabase Realtime Optimizer | supabase-realtime-optimizer | — |
...
| Architecture Modernizer | architecture-modernizer | — |
...
### Bmd Custom Core Bmad Master.agent (id: bmd-custom-core-bmad-master.agent)
Source: .github/agents/bmd-custom-core-bmad-master.agent.md

- How to activate: Mention "As bmd-custom-core-bmad-master.agent, ..." or "Use Bmd Custom Core Bmad Master.agent to ..."
...
### Bmd Custom Bmm Ux Designer.agent (id: bmd-custom-bmm-ux-designer.agent)
Source: .github/agents/bmd-custom-bmm-ux-designer.agent.md

- How to activate: Mention "As bmd-custom-bmm-ux-designer.agent, ..." or "Use Bmd Custom Bmm Ux Designer.agent to ..."
...
### Bmd Custom Bmm Tech Writer.agent (id: bmd-custom-bmm-tech-writer.agent)
Source: .github/agents/bmd-custom-bmm-tech-writer.agent.md

- How to activate: Mention "As bmd-custom-bmm-tech-writer.agent, ..." or "Use Bmd Custom Bmm Tech Writer.agent to ..."
...
### Bmd Custom Bmm Tea.agent (id: bmd-custom-bmm-tea.agent)
Source: .github/agents/bmd-custom-bmm-tea.agent.md

- How to activate: Mention "As bmd-custom-bmm-tea.agent, ..." or "Use Bmd Custom Bmm Tea.agent to ..."
...
### Bmd Custom Bmm Sm.agent (id: bmd-custom-bmm-sm.agent)
Source: .github/agents/bmd-custom-bmm-sm.agent.md

- How to activate: Mention "As bmd-custom-bmm-sm.agent, ..." or "Use Bmd Custom Bmm Sm.agent to ..."
...
### Bmd Custom Bmm Quick Flow Solo Dev.agent (id: bmd-custom-bmm-quick-flow-solo-dev.agent)
Source: .github/agents/bmd-custom-bmm-quick-flow-solo-dev.agent.md

- How to activate: Mention "As bmd-custom-bmm-quick-flow-solo-dev.agent, ..." or "Use Bmd Custom Bmm Quick Flow Solo Dev.agent to ..."
...
### Bmd Custom Bmm Pm.agent (id: bmd-custom-bmm-pm.agent)
Source: .github/agents/bmd-custom-bmm-pm.agent.md

- How to activate: Mention "As bmd-custom-bmm-pm.agent, ..." or "Use Bmd Custom Bmm Pm.agent to ..."
...
### Bmd Custom Bmm Dev.agent (id: bmd-custom-bmm-dev.agent)
Source: .github/agents/bmd-custom-bmm-dev.agent.md

- How to activate: Mention "As bmd-custom-bmm-dev.agent, ..." or "Use Bmd Custom Bmm Dev.agent to ..."
...
### Bmd Custom Bmm Architect.agent (id: bmd-custom-bmm-architect.agent)
Source: .github/agents/bmd-custom-bmm-architect.agent.md

- How to activate: Mention "As bmd-custom-bmm-architect.agent, ..." or "Use Bmd Custom Bmm Architect.agent to ..."
...
### Bmd Custom Bmm Analyst.agent (id: bmd-custom-bmm-analyst.agent)
Source: .github/agents/bmd-custom-bmm-analyst.agent.md

- How to activate: Mention "As bmd-custom-bmm-analyst.agent, ..." or "Use Bmd Custom Bmm Analyst.agent to ..."
...
### Bmd Custom Bmb Workflow Builder.agent (id: bmd-custom-bmb-workflow-builder.agent)
Source: .github/agents/bmd-custom-bmb-workflow-builder.agent.md

- How to activate: Mention "As bmd-custom-bmb-workflow-builder.agent, ..." or "Use Bmd Custom Bmb Workflow Builder.agent to ..."
...
### Bmd Custom Bmb Module Builder.agent (id: bmd-custom-bmb-module-builder.agent)
Source: .github/agents/bmd-custom-bmb-module-builder.agent.md

- How to activate: Mention "As bmd-custom-bmb-module-builder.agent, ..." or "Use Bmd Custom Bmb Module Builder.agent to ..."
...
### Bmd Custom Bmb Agent Builder.agent (id: bmd-custom-bmb-agent-builder.agent)
Source: .github/agents/bmd-custom-bmb-agent-builder.agent.md

- How to activate: Mention "As bmd-custom-bmb-agent-builder.agent, ..." or "Use Bmd Custom Bmb Agent Builder.agent to ..."
...
### Web Accessibility Checker (id: web-accessibility-checker)
Source: .claude/agents/web-accessibility-checker.md

- How to activate: Mention "As web-accessibility-checker, ..." or "Use Web Accessibility Checker to ..."
...
### Supabase Realtime Optimizer (id: supabase-realtime-optimizer)
Source: .claude/agents/supabase-realtime-optimizer.md

- How to activate: Mention "As supabase-realtime-optimizer, ..." or "Use Supabase Realtime Optimizer to ..."
...
### Security Auditor (id: security-auditor)
Source: .claude/agents/security-auditor.md

- How to activate: Mention "As security-auditor, ..." or "Use Security Auditor to ..."
...
### React Performance Optimizer (id: react-performance-optimizer)
Source: .claude/agents/react-performance-optimizer.md

- How to activate: Mention "As react-performance-optimizer, ..." or "Use React Performance Optimizer to ..."
...
### Penetration Tester (id: penetration-tester)
Source: .claude/agents/penetration-tester.md

- How to activate: Mention "As penetration-tester, ..." or "Use Penetration Tester to ..."
...
### Mobile Developer (id: mobile-developer)
Source: .claude/agents/mobile-developer.md

- How to activate: Mention "As mobile-developer, ..." or "Use Mobile Developer to ..."
...
### Mlops Engineer (id: mlops-engineer)
Source: .claude/agents/mlops-engineer.md

- How to activate: Mention "As mlops-engineer, ..." or "Use Mlops Engineer to ..."
...
### Mcp Expert (id: mcp-expert)
Source: .claude/agents/mcp-expert.md

- How to activate: Mention "As mcp-expert, ..." or "Use Mcp Expert to ..."
...
### Legacy Modernizer (id: legacy-modernizer)
Source: .claude/agents/legacy-modernizer.md

- How to activate: Mention "As legacy-modernizer, ..." or "Use Legacy Modernizer to ..."
...
### Deployment Engineer (id: deployment-engineer)
Source: .claude/agents/deployment-engineer.md

- How to activate: Mention "As deployment-engineer, ..." or "Use Deployment Engineer to ..."
...
### Computer Vision Engineer (id: computer-vision-engineer)
Source: .claude/agents/computer-vision-engineer.md

- How to activate: Mention "As computer-vision-engineer, ..." or "Use Computer Vision Engineer to ..."
...
### Compliance Specialist (id: compliance-specialist)
Source: .claude/agents/compliance-specialist.md

- How to activate: Mention "As compliance-specialist, ..." or "Use Compliance Specialist to ..."
...
### Cloud Migration Specialist (id: cloud-migration-specialist)
Source: .claude/agents/cloud-migration-specialist.md

- How to activate: Mention "As cloud-migration-specialist, ..." or "Use Cloud Migration Specialist to ..."
...
### Architecture Modernizer (id: architecture-modernizer)
Source: .claude/agents/architecture-modernizer.md

- How to activate: Mention "As architecture-modernizer, ..." or "Use Architecture Modernizer to ..."
...
### Ai Engineer (id: ai-engineer)
Source: .claude/agents/ai-engineer.md

- How to activate: Mention "As ai-engineer, ..." or "Use Ai Engineer to ..."
...
### Bmd Custom Core Bmad Master.agent (id: bmd-custom-core-bmad-master.agent)
Source: [.github/agents/bmd-custom-core-bmad-master.agent.md](.github/agents/bmd-custom-core-bmad-master.agent.md)

- When to use: —
- How to activate: Mention "As bmd-custom-core-bmad-master.agent, ..." to get role-aligned behavior
- Full definition: open the source file above (content not embedded)

### Bmd Custom Bmm Ux Designer.agent (id: bmd-custom-bmm-ux-designer.agent)
Source: [.github/agents/bmd-custom-bmm-ux-designer.agent.md](.github/agents/bmd-custom-bmm-ux-designer.agent.md)

- When to use: —
- How to activate: Mention "As bmd-custom-bmm-ux-designer.agent, ..." to get role-aligned behavior
- Full definition: open the source file above (content not embedded)

### Bmd Custom Bmm Tech Writer.agent (id: bmd-custom-bmm-tech-writer.agent)
Source: [.github/agents/bmd-custom-bmm-tech-writer.agent.md](.github/agents/bmd-custom-bmm-tech-writer.agent.md)

- When to use: —
- How to activate: Mention "As bmd-custom-bmm-tech-writer.agent, ..." to get role-aligned behavior
- Full definition: open the source file above (content not embedded)

### Bmd Custom Bmm Tea.agent (id: bmd-custom-bmm-tea.agent)
Source: [.github/agents/bmd-custom-bmm-tea.agent.md](.github/agents/bmd-custom-bmm-tea.agent.md)

- When to use: —
- How to activate: Mention "As bmd-custom-bmm-tea.agent, ..." to get role-aligned behavior
- Full definition: open the source file above (content not embedded)

### Bmd Custom Bmm Sm.agent (id: bmd-custom-bmm-sm.agent)
Source: [.github/agents/bmd-custom-bmm-sm.agent.md](.github/agents/bmd-custom-bmm-sm.agent.md)

- When to use: —
- How to activate: Mention "As bmd-custom-bmm-sm.agent, ..." to get role-aligned behavior
- Full definition: open the source file above (content not embedded)

### Bmd Custom Bmm Quick Flow Solo Dev.agent (id: bmd-custom-bmm-quick-flow-solo-dev.agent)
Source: [.github/agents/bmd-custom-bmm-quick-flow-solo-dev.agent.md](.github/agents/bmd-custom-bmm-quick-flow-solo-dev.agent.md)

- When to use: —
- How to activate: Mention "As bmd-custom-bmm-quick-flow-solo-dev.agent, ..." to get role-aligned behavior
- Full definition: open the source file above (content not embedded)

### Bmd Custom Bmm Pm.agent (id: bmd-custom-bmm-pm.agent)
Source: [.github/agents/bmd-custom-bmm-pm.agent.md](.github/agents/bmd-custom-bmm-pm.agent.md)

- When to use: —
- How to activate: Mention "As bmd-custom-bmm-pm.agent, ..." to get role-aligned behavior
- Full definition: open the source file above (content not embedded)

### Bmd Custom Bmm Dev.agent (id: bmd-custom-bmm-dev.agent)
Source: [.github/agents/bmd-custom-bmm-dev.agent.md](.github/agents/bmd-custom-bmm-dev.agent.md)

- When to use: —
- How to activate: Mention "As bmd-custom-bmm-dev.agent, ..." to get role-aligned behavior
- Full definition: open the source file above (content not embedded)

### Bmd Custom Bmm Architect.agent (id: bmd-custom-bmm-architect.agent)
Source: [.github/agents/bmd-custom-bmm-architect.agent.md](.github/agents/bmd-custom-bmm-architect.agent.md)

- When to use: —
- How to activate: Mention "As bmd-custom-bmm-architect.agent, ..." to get role-aligned behavior
- Full definition: open the source file above (content not embedded)

### Bmd Custom Bmm Analyst.agent (id: bmd-custom-bmm-analyst.agent)
Source: [.github/agents/bmd-custom-bmm-analyst.agent.md](.github/agents/bmd-custom-bmm-analyst.agent.md)

- When to use: —
- How to activate: Mention "As bmd-custom-bmm-analyst.agent, ..." to get role-aligned behavior
- Full definition: open the source file above (content not embedded)

### Bmd Custom Bmb Workflow Builder.agent (id: bmd-custom-bmb-workflow-builder.agent)
Source: [.github/agents/bmd-custom-bmb-workflow-builder.agent.md](.github/agents/bmd-custom-bmb-workflow-builder.agent.md)

- When to use: —
- How to activate: Mention "As bmd-custom-bmb-workflow-builder.agent, ..." to get role-aligned behavior
- Full definition: open the source file above (content not embedded)

### Bmd Custom Bmb Module Builder.agent (id: bmd-custom-bmb-module-builder.agent)
Source: [.github/agents/bmd-custom-bmb-module-builder.agent.md](.github/agents/bmd-custom-bmb-module-builder.agent.md)

- When to use: —
- How to activate: Mention "As bmd-custom-bmb-module-builder.agent, ..." to get role-aligned behavior
- Full definition: open the source file above (content not embedded)

### Bmd Custom Bmb Agent Builder.agent (id: bmd-custom-bmb-agent-builder.agent)
Source: [.github/agents/bmd-custom-bmb-agent-builder.agent.md](.github/agents/bmd-custom-bmb-agent-builder.agent.md)

- When to use: —
- How to activate: Mention "As bmd-custom-bmb-agent-builder.agent, ..." to get role-aligned behavior
- Full definition: open the source file above (content not embedded)

### Web Accessibility Checker (id: web-accessibility-checker)
Source: [.claude/agents/web-accessibility-checker.md](.claude/agents/web-accessibility-checker.md)

- When to use: —
- How to activate: Mention "As web-accessibility-checker, ..." to get role-aligned behavior
- Full definition: open the source file above (content not embedded)

### Supabase Realtime Optimizer (id: supabase-realtime-optimizer)
Source: [.claude/agents/supabase-realtime-optimizer.md](.claude/agents/supabase-realtime-optimizer.md)

- When to use: —
- How to activate: Mention "As supabase-realtime-optimizer, ..." to get role-aligned behavior
- Full definition: open the source file above (content not embedded)
...
- When to use: —
- How to activate: Mention "As security-auditor, ..." to get role-aligned behavior
- Full definition: open the source file above (content not embedded)

### React Performance Optimizer (id: react-performance-optimizer)
Source: [.claude/agents/react-performance-optimizer.md](.claude/agents/react-performance-optimizer.md)

- When to use: —
- How to activate: Mention "As react-performance-optimizer, ..." to get role-aligned behavior
- Full definition: open the source file above (content not embedded)
...
### Penetration Tester (id: penetration-tester)
Source: [.claude/agents/penetration-tester.md](.claude/agents/penetration-tester.md)

- When to use: —
- How to activate: Mention "As penetration-tester, ..." to get role-aligned behavior
- Full definition: open the source file above (content not embedded)

### Mobile Developer (id: mobile-developer)
Source: [.claude/agents/mobile-developer.md](.claude/agents/mobile-developer.md)

- When to use: —
- How to activate: Mention "As mobile-developer, ..." to get role-aligned behavior
- Full definition: open the source file above (content not embedded)
...
- When to use: —
- How to activate: Mention "As mlops-engineer, ..." to get role-aligned behavior
- Full definition: open the source file above (content not embedded)

### Mcp Expert (id: mcp-expert)
Source: [.claude/agents/mcp-expert.md](.claude/agents/mcp-expert.md)

- When to use: —
- How to activate: Mention "As mcp-expert, ..." to get role-aligned behavior
- Full definition: open the source file above (content not embedded)

### Legacy Modernizer (id: legacy-modernizer)
Source: [.claude/agents/legacy-modernizer.md](.claude/agents/legacy-modernizer.md)

- When to use: —
- How to activate: Mention "As legacy-modernizer, ..." to get role-aligned behavior
- Full definition: open the source file above (content not embedded)
...
### Deployment Engineer (id: deployment-engineer)
Source: [.claude/agents/deployment-engineer.md](.claude/agents/deployment-engineer.md)

- When to use: —
- How to activate: Mention "As deployment-engineer, ..." to get role-aligned behavior
- Full definition: open the source file above (content not embedded)
...
### Computer Vision Engineer (id: computer-vision-engineer)
Source: [.claude/agents/computer-vision-engineer.md](.claude/agents/computer-vision-engineer.md)

- When to use: —
- How to activate: Mention "As computer-vision-engineer, ..." to get role-aligned behavior
- Full definition: open the source file above (content not embedded)

### Compliance Specialist (id: compliance-specialist)
Source: [.claude/agents/compliance-specialist.md](.claude/agents/compliance-specialist.md)

- When to use: —
- How to activate: Mention "As compliance-specialist, ..." to get role-aligned behavior
- Full definition: open the source file above (content not embedded)
...
### Cloud Migration Specialist (id: cloud-migration-specialist)
Source: [.claude/agents/cloud-migration-specialist.md](.claude/agents/cloud-migration-specialist.md)

- When to use: —
- How to activate: Mention "As cloud-migration-specialist, ..." to get role-aligned behavior
- Full definition: open the source file above (content not embedded)

### Architecture Modernizer (id: architecture-modernizer)
Source: [.claude/agents/architecture-modernizer.md](.claude/agents/architecture-modernizer.md)

- When to use: —
- How to activate: Mention "As architecture-modernizer, ..." to get role-aligned behavior
- Full definition: open the source file above (content not embedded)

### Ai Engineer (id: ai-engineer)
Source: [.claude/agents/ai-engineer.md](.claude/agents/ai-engineer.md)

- When to use: —
- How to activate: Mention "As ai-engineer, ..." to get role-aligned behavior
- Full definition: open the source file above (content not embedded)
