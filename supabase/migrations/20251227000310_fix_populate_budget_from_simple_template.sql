-- Migration: fix_populate_budget_from_simple_template
-- Description: Fixes the populate_budget_from_simple_template function to correctly query template projects by name pattern.
...
BEGIN
  -- Find the default materials template project by name pattern
  ...
  -- Find the default labor template project by name pattern
