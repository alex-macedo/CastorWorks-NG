...
drop policy if exists content_service_anon_select_all
on content.service;
...
drop policy if exists content_service_authenticated_select_all
on content.service;
...
drop policy if exists content_error_anon_select_all
on content.error;
...
drop policy if exists content_error_authenticated_select_all
on content.error;
